...
export const generateText = ({ markovOrder, startString, trainingData, numSentences=1, maxLength=999 }) => {
  const nGramsDataset = buildSampleData(trainingData, markovOrder)
  let generatedText = ''
...
export const generateRandomStartString = ({ trainingData, markovOrder }) => {
